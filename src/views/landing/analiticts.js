      ...
      <Grid container spacing={4} alignItems="center">
        <Grid item xs={12} md={6}>
          <Typography variant="h2" sx={{ marginBottom: theme.spacing(2) }}>
            Relax you are<br/> In save hands
          </Typography>
          <Typography variant="body1" sx={{ lineHeight: 1.7 }}>
          Our expert Nail Artists are skilled in The NailsavvyWay, ensuring a flawless nail treatment from start to finish. Enjoy personalized style and care advice, tailored specifically for you, while our professionals work their magic.          </Typography>
